		...
		<article class="single-page">
			...
			<div class="container page-content">
				...
				<form action="enviar.php" method="post">
					...
					<input type="text" id="user" name="user" placeholder="¿Cual es tu usuario?" required />
					
					<label for="servicio">Como calificarias el servicio?:</label>
					<input type="text" id="servicio" name="servicio" placeholder="¿Bueno, Malo, Regular?" required />
					
					<label for="sugerencia">Sugerencias:</label>
					<textarea id="sugerencia" name="sugerencia" rows="8" placeholder="¿Que te gustaria que mejoraramos? " required ></textarea>
					
					<input type="submit" value="Enviar sugerencia" class="btn" style="margin-top: 10px;"/>
