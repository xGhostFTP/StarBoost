		...
		<article class="single-page">
			...
			<header class="page-header">
				<div class="container">
					...
					<p>Aqui encontraras las principales estadisticas relacionadas con nuestros clientes.  </p>
...
<head>
  ...
  <body>
    <div id="regions_div" style="width: 2000px; height: 1000px;"></div>
  </body>
...
<div id="barchart_values" style="width: 2200px; height: 1000px;"></div>
