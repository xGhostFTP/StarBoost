...
<df-messenger
  ...
  language-code="es"
></df-messenger>
	<header id="main-header" class="container cf">
		
		<div class="logo-header">
			<h1 class="logo"><img src="img/logo2.png" alt="logo" width="200" height="40"></h1>
			<h2 class="slogan"></h2>
		</div><!-- /#logo-header -->
	...
	<main id="content-area">
		...
		<section id="hero-container">
			...
			<article id="hero" class="container">
				<span class="dispositivos"><img src="img/home-dispositivos.png" alt="home-dispositivos"></span>
				<header>
					<h2>Servicio para subir cuentas de League of Legends</h2>
				</header>
				<p>Se sube hasta diamante</p>
				<a href="contactanos" class="btn">Trabajemos juntos</a> 
				<a href="servicios" class="btn btn-light">Ver Servicios</a>
			</article>
		...
		<section id="servicios-home" class="container">
			...
			<div class="text-center">
				<a href="servicios" class="btn btn-light">Ver más detalles</a>
			</div>
		...
		<div class="flexslider container">
			<div class="slides">
				...
				<div class="testimonio">
					<blockquote>
						<p>Este es un servicio que busca apoyar a los jugadores a subir y mejorar su desempeño para conseguir sus metas en sus juegos preferidos.</p>
						<cite><img src="img/logo2.png" alt="Nombre del autor" class="alignleft"><strong>Star Eloboost.</strong>El mejor servicio de coaching de todo latinoamerica.</cite>
					</blockquote>
				</div><!-- /.testimonio -->
				<br><br><br><br>
				<div class="testimonio">
					<blockquote>
						<p>Contamos con los mejores coachers para que aprendas de la manera más eficaz y amigable, nuestra finalidad es que puedas alcanzar todas esas metas
							que hasta entonces no habias conseguido.
						</p>
						<cite><img src="img/coacher.png"  class="alignleft"><strong>Star Eloboost.</strong>Tenemos los mejores coachers.</cite>
					</blockquote>
				</div><!-- /.testimonio -->
				<br><br><br><br>
				<div class="testimonio">
					<blockquote>
						<p>Buscamos ofrecerte un servicio de total calidad, y estabilidad, estamos dispuestos a contestarte cualquier duda que tengas en cualquier momento
							para que de está manera te sientas comunicado con nosotros.
						</p>
						<cite><img src="img/calidad.png" alt="Nombre del autor" class="alignleft"><strong>Star Eloboost.</strong>El servicio mas fiable de LAN.</cite>
					</blockquote>
				</div><!-- /.testimonio -->
		<br><br>
			</div><!-- /.slides -->
	...
	<footer id="main-footer">
		...
		<div class="footer-call-to-action">
			...
			<p class="container">¿Estás listo para recibir el mejor eloboost de tu vida? <a href="contactanos" class="btn">Trabajemos juntos</a></p>
